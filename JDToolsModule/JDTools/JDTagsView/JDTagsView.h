...
@protocol JDTagsViewDelegate <NSObject>

@optional
- (BOOL)tagsView:(JDTagsView *)tagsView shouldSelectTagAtIndex:(NSUInteger)index;
- (void)tagsView:(JDTagsView *)tagsView didSelectTagAtIndex:(NSUInteger)index;

- (BOOL)tagsView:(JDTagsView *)tagsView shouldDeselectItemAtIndex:(NSUInteger)index;
- (void)tagsView:(JDTagsView *)tagsView didDeSelectTagAtIndex:(NSUInteger)index;

//自己加入自动高代理
- (void)tagsView:(JDTagsView *)tagsView autoHeight:(CGFloat)autoHeight;
