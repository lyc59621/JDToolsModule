...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _nameLbl = [[UILabel alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(_iconBtn.frame) + 5.0f, kMoreItemIconSize, kMoreItemH- kMoreItemIconSize)];
        _nameLbl.textAlignment = NSTextAlignmentCenter;
        _nameLbl.textColor = THEXCOLOR(0x7a767a);
