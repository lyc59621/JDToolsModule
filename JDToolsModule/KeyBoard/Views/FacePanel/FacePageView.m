...
- (void)loadSystemEmoji:(NSArray *)faceData
{
    ...
    [btn setImage:[UIImage imageNamed:@"Delete_ios7"] forState:UIControlStateHighlighted];
...
- (void)loadCustomEmoji:(NSArray *)faceData
{
    for (int i = 0; i < faceData.count; i++) {
        ...
        UIImage  *img = [UIImage imageNamed:fm.png inBundle:imgBundle
 compatibleWithTraitCollection:nil];
        [btn setImage:img forState:UIControlStateNormal];
        btn.faceTitle = fm.chs;
    }
    FaceButton *btn =self.buttons[faceData.count];
    btn.hidden = NO;
    [btn setImage:[UIImage imageNamed:@"Delete_ios7"] forState:UIControlStateNormal];
...
- (void)loadGifEmoji:(NSArray *)faceData
{
    for (int i = 0; i < faceData.count; i++) {
        ...
        [btn setImage:[UIImage imageNamed:fm.faceIcon] forState:UIControlStateHighlighted];
