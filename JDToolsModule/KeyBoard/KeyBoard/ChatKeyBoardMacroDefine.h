...
//ChatKeyBoard背景颜色
#define kChatKeyBoardColor  [UIColor colorWithRed:26.0f / 0xff green:26.0f / 0xff blue:26.0f / 0xff alpha:0.73f]
// [UIColor colorWithRed:245/255.f green:245/255.f blue:245/255.f alpha:1.0f]
...
#define kFacePanelBottomToolBarHeight   37 //40
#define kUIPageControllerHeight         25
#define KBOTTOM_BUTTON_WIDTH 45
